...
export const IMAGE_PROVIDER_METADATA: Record<ImageProviderId, ImageProviderMetadata> = {
  ...
  openai: {
    ...
    knownLimitations: "Reference-image edits use base64 output; no seed control",
    expectedTime: "10-25s per image",
  },
  gemini: {
    id: "gemini",
    ...
    contentFilterBehavior: "Error response on flag",
    storageHandling: "Base64 data URI copied into storage",
    knownLimitations: "Best high-fidelity reference handling is documented for up to 5 images, with up to 14 total; uses 1K output in workbench",
